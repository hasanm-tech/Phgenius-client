    ...
    return (
        <header>
            <div className="navbar bg-neutral py-6 fixed top-0 z-50">
                ...
                <div className="navbar-end text-white text-xl mr-4 space-x-4">
                    {
                        user? <>
                        <div className="space-x-4 flex justify-between">
                        <NavLink className="">
                            <img className="md:w-10 md:h-10 w-6 h-6 rounded-xl" src={user.photoURL} alt="" />
                        </NavLink>
                        <button className="md:text-xl text-[10px] " onClick={handleLogout}><NavLink to='/'> Logout  </NavLink></button>
                        </div>
                        </>
                        : 
                    ...
                    <input className="text-md" style={{fontSize: '20px'}}  type="checkbox" onChange={handleToggle} />
